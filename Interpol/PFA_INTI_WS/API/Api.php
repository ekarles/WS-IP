...
class Api
{
    ...
    private $obj;
    private $inti;
    private $acciones = array('NOMINALS', 'NOMINALSEXACT', 'NOMINALSDETAILS', 'NOMINALSIMAGE', 'GETNOTICE', 'GETNOTICESMOVEMENTS', 'GETNOTICEPDFFILE', 'ALLIMAGEFILE', 'GETFINGERPRINT', 'SLTDDETAILS', 'SLTD', 'SMVDETAILS', 'SMV');
    ...
    public function API()
    {
        ...
        switch ($method) {
            case 'POST':
                ...
                // SETEAR VERSION ANTES
                if (isset($this->obj->version) && !empty($this->obj->version)) {
                    $this->inti->setVersion($this->obj->version);
                }
