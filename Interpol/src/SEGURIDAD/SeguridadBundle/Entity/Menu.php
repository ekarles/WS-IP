...
class Menu{
    ...
    public function getOpcionesMenu(){
        ...
        foreach ( $OpcionesMenu as $om){
            ...
            if( $om["permisoid"] == 125 || $om["permisoid"] == 127){
                if($om["permisoid"] == 125){
                    $titulo = "Administración CNRT";
                }else{
                    $titulo = "Positivos CNRT";
                }
                $sm["opcionmenu"] = "SI";
                $sm["titulo"] = $titulo;
                $sm["accion"] = "admin_cnrtpersona";
                $sm["permisoid"] = $om["permisoid"];
                $sm["orden"] = 4;
                $sm["menu"] = 2;
            ...
            if( $om["permisoid"] == 81){
            	...
            	$sm["accion"] = "auditoriageneral";
            	$sm["orden"] = 6;
            	$sm["menu"] = 4;
            	$sm["iconomenu"] = "fas fa-database";
            }
            
            if( $om["permisoid"] == 122 || $om["permisoid"] == 123){
                $sm["opcionmenu"] = "SI";
            ...
            if( $om["permisoid"] == 126){
                $sm["opcionmenu"] = "SI";
                $sm["titulo"] = "Consulta de Armas (IARMS)";
                $sm["accion"] = "arma";
                $sm["orden"] = 6;
                $sm["menu"] = 1;
                $sm["iconomenu"] = "fas fa-address-book";
